...
function readCardImage(id: string): string | null {
    const imagePath = path.join(process.cwd(), 'public', 'assets', id, 'front.png')
...
function loadManifest(): CardManifest | null {
    const manifestPath = path.join(process.cwd(), 'public', 'data', 'cards.json')
    try {
    ...
    const response = new ImageResponse(
        <div
            style={{
                ...
                width: '100%',
                height: '100%',
                background: 'linear-gradient(135deg, #1c1916 0%, #0e0d0b 60%, #141210 100%)',
        ...
        >
            ...
            <div
                style={{
                    ...
                    bottom: 0,
                    width: 4,
                    background: 'linear-gradient(to bottom, rgba(201,168,76,0.7) 0%, rgba(201,168,76,0.1) 100%)'
                }}
            />
            ...
            <div
                style={{
                    ...
                    justifyContent: 'center',
                    flex: 1,
                    padding: imageDataUrl ? '50px 50px 50px 20px' : '50px 80px'
                }}
            >
                <div
                    style={{
