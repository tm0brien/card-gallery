    ...
    return (
        <div className={styles.editorSection}>
            ...
            <p className={styles.sectionHint}>
                Describe how the card artwork should come to life. The card border, slab, and label stay perfectly
                static — only the artwork area animates.
            </p>
            ...
            <div className={styles.canvasWrap}>
                <canvas ref={canvasRef} className={styles.videoCanvas} style={{ aspectRatio }} />
                {videoUrl && (
            ...
            {videoUrl && !generating && (
                <div className={styles.previewActions}>
                    ...
                    <button className={`${styles.toolBtn} ${styles.saveBtn}`} onClick={handleSave} disabled={saving}>
