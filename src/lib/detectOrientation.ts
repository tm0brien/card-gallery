...
export function orientationFromDimensions(width: number, height: number): ImageOrientation {
...
export function detectFrontOrientation(assetsDir: string, id: string): ImageOrientation | undefined {
